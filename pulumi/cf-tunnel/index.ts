...
// Get the foundry service name from the foundry stack
const foundryStack = new pulumi.StackReference("foundry-stack", {
	name: "weakphish/foundry/homelab",
});
const foundryServiceName = foundryStack.getOutput("foundryServiceName");
